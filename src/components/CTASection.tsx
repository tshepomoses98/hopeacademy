export function CTASection() {
  return (
    <section className="py-20 gradient-hero relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-72 h-72 bg-green-400 rounded-full opacity-20 blur-3xl" />

      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
        <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-5">
          Ready to Bridge Your Dreams Into Reality?
        </h2>
        <p className="text-green-100 text-lg mb-10 leading-relaxed">
          Don't let complexity hold you back. HopeBridge is here to guide you through every step — affordably, professionally, and with care.
        </p>
